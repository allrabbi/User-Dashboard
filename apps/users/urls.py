...
from .views import UsersRegister, UsersLogin, UsersLogout, UsersEdit, UsersUpdate, UsersShow, UsersCreateMessage, UsersCreateComment, UsersIndex, UsersRedirect, UsersAdmin, UsersNew, UsersDestroy, UsersSetAdmin
